...
class Accounting:
    def acclass(self):
        cursor.execute("""create table acclass(
    ...
    def acclassdsc(self):
        cursor.execute("""create table acclassdsc(
    ...
    def acclassrel(self):
        cursor.execute("""create table acclassrel(
    ...
    def faccount(self):
        cursor.execute("""create table faccount(
        ...
        cursor.execute("create index ac_03 on faccount(routingnumber)")
        cursor.execute("create index ac_04 on faccount(setccurr)")
    ...
    def faccountdsc(self):
        cursor.execute("""create table faccountdsc(
    ...
    def accountclassrel(self):
        cursor.execute("""create table accountclassrel(
            acclass_id bigint not null,
            faccount_id bigint not null,
    ...
    def transactiontype(self):
        ...
        cursor.execute("create index ac_05 on transactiontype(code)")
    ...
    def transaction(self):
        ...
        cursor.execute("create index ac_06 on transaction(typecode)")
        cursor.execute("create index ac_07 on transaction(amount)")
    
    def facctransaction(self):
        cursor.execute("""create table facctransaction(
            transaction_id bigint not null,
            faccount_id bigint not null,
            crdr char(1) not null,
            primary key(transaction_id,faccount_id)
        )""")
        cursor.execute("create index ac_08 on facctransaction(crdr)")
